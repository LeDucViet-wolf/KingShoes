...
// get orders
export const getNewsletters = () => get(url.GET_NEWSLETTERS)

// get all bet
export const getAllBets = () => get(url.GET_BETALL)
export const getAllBetsClose = () => get(url.GET_BETCLOSE)
export const getAllBetsOpen = () => get(url.GET_BETOPEN)
export const getAllBetsChallenge = () => get(url.GET_BETCHALLENGE)
export const getAllBetsReview = () => get(url.GET_BETREVIEW)

// get orders
export const deleteNewsletters = newsletter =>
  del(url.DELETE_NEWSLETTER, { headers: { newsletter } })

// get poll
export const getPolls = () => get(url.GET_POLLS)
