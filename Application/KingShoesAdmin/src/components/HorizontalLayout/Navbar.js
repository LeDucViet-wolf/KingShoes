...
const Navbar = props => {
  ...
  const secure_url = process.env.REACT_APP_SECURITY_URL
              ...
              <ul className="navbar-nav">
                <li className="nav-item dropdown">
                  ...
                  >
                    ...
                    <Link
                      to={secure_url + "/dashboard-saas"}
                      className="dropdown-item"
                    >
                      {props.t("Saas")}
                    </Link>
                    <Link
                      to={secure_url + "/dashboard-crypto"}
                      className="dropdown-item"
                    >
                      {props.t("Crypto")}
                    </Link>
                    <Link to={secure_url + "/blog"} className="dropdown-item">
                      {props.t("Blog")}
                    </Link>
                  </div>
                </li>
