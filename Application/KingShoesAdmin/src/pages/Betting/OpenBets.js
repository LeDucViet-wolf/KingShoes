...
function OpenBets() {
    //meta title
    document.title = "OpenBets Bet | Trumpbet24 Admin & Dashboard"
    ...
    const [allBetsOpen, SetAllBetsOpen] = useState([])
    useEffect(() => {
        SetAllBetsOpen(allBets.filter(b=>b.counter.id == 1))
    }, [])
        ...
        <React.Fragment>
            ...
            <div className="page-content">
                <div className="container-fluid">
                    <Breadcrumbs title="Bet" breadcrumbItem="Open Bet" />
                    <Row>
                        <Col xs="12">
                            <Card>
                                <CardBody>
