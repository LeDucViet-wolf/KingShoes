...
function CloseBets() {
    //meta title
    document.title = "Close Bet | Trumpbet24 Admin & Dashboard"
    ...
    const [allBetsClose, SetAllBetsClose] = useState([])
    useEffect(() => {
        SetAllBetsClose(allBets.filter(b=>b.counter.id == 2))
    }, [])
        ...
        <React.Fragment>
            ...
            <div className="page-content">
                <div className="container-fluid">
                    <Breadcrumbs title="Bet" breadcrumbItem="Close Bet" />
                    <Row>
                        <Col xs="12">
                            <Card>
                                <CardBody>
