...
const PagesComingsoon = () => {
  ...
  //meta title
  document.title = "Coming Soon | Trumpbet24 Admin & Dashboard"

  return (
    <React.Fragment>
      <div className="home-btn d-none d-sm-block">
        <Link to={process.env.REACT_APP_SECURITY_URL} className="text-white">
          ...
          <Row>
            <Col lg="12">
              <div className="text-center">
                <Link
                  to={process.env.REACT_APP_SECURITY_URL + "/dashboard"}
